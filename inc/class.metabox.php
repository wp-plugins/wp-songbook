...
class songbook_metabox extends songbook_functions{
    ...
    function register_metabox(){
        if($this->option('enable_filelinking')!='enable'||!current_user_can($this->option('mincap_addfiles')))return $this->option('enable_filelinking');
        add_meta_box('songbook_files',__('Link files','wpsongbook'),array($this,'metabox_content'),'song','side','default');
    }
    
    function metabox_content(){
        global $post;
    echo'<div class="tab" id="songfiles">';
