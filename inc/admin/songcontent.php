...
<div class="field" id="disp_videolinkinsong">
    <div class="left">
        <?php _e('Display video link in songs', WPSB_LANGDOM); ?>
               
        <div class="note">
        <?php _e('Whether to display video link in songs', WPSB_LANGDOM); ?>
        </div>
    </div>
    <div class="right">
        <select name="songbook[disp_videolinkinsong]">
            <option value="false" <?php selected($this->option('disp_videolinkinsong'), 'false'); ?>><?php _e('Don\'t display',WPSB_LANGDOM); ?>
            <option value="display" <?php selected($this->option('disp_videolinkinsong'), 'display'); ?>><?php _e('Display',WPSB_LANGDOM); ?>
        </select>
    </div>
</div>
