...
abstract class songbook_functions {
    ...
    function defs($optname = false) {
        ...
        $defs = array(
            ...
            'text_error_nothingfound' => __('We\'re sorry but nothing was found for selected conditions. An (probably green) alien from space have stolen everything similar this morning. Please, try something different',WPSB_LANGDOM),
            'text_error_disabled'=>__('We\'re sorry, but this features are disabled on this site',WPSB_LANGDOM),
            'disp_backtolistinsong'=>'display',
            'disp_filelistinsong' =>'display',
            'disp_filelistforlogged' =>'false',
